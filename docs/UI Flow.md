...
This document describes the actual implemented UI flow of PSP Moonlight v0.2.0-beta. It replaces the original development spec, which described intended behavior that was sometimes implemented differently or not yet implemented at all.
