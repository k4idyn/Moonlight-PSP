...
# Conditionally include -lpthread for non-PSP builds
ifeq ($(findstring _PSP,$(CFLAGS)),)
    PTHREAD_LIBS = -lpthread
else
    PTHREAD_LIBS =
endif

LIBS = -lenet -lmbedtls -lmbedx509 -lmbedcrypto -leverest -lp256m -lopus $(PTHREAD_LIBS) lib/libmxml.a -lpspvfpu -lpspaudio -lpspmpeg -lpspgum -lpspgu -lpsprtc -lpspwlan -lpsppower -lz -lm
