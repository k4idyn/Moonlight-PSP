/*
 * Mini-XML header file for Moonlight PSP.
 *
 ...
 *
 * For the full license, see the COPYING file included in this 
 * repository at include/COPYING.
 */
...
#ifndef MOONLIGHT_MXML_H
#  define MOONLIGHT_MXML_H
