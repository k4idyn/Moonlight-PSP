/*
 * me.c - Media Engine User-Side Control Interface
 *
 * Bridge between user-mode code and the moonlight_me_helper.prx kernel module.
 * Provides CallME (blocking), BeginME (non-blocking), WaitME, CheckME, and
 * SignalME for dispatching VFPU YUV→RGBA work to the ME coprocessor.
 */
